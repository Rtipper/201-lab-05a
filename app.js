...
function sumArray(sumArr) { //eslint-disable-line
  var sum = getSum(sumArr[0],getSum(sumArr[1],sumArr[2]));
  return [sum, `${sumArr[0]},${sumArr[1]},${sumArr[2]} was passed in as an array of numbers, and 9 is their sum.`];
...
function multiplyArray(multArr) { //eslint-disable-line
  var sum = getProduct(multArr[0],getProduct(multArr[1],multArr[2]));
  return [sum, `The numbers ${multArr[0]},${multArr[1]},${multArr[2]} have a product of 24.`];
